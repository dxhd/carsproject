...
<html lang="eng">
    ...
    <body class="bg-img" background="images/background1.png">
        <header>
        ...
        <div class='content'>
            ...
            <p id="welcome-text">On this site you can try to drive different tracks on different vehicles. Try to start by adding a vehicle to your garage.
            <a class='button' href="adding.php">Add vehicle</a>
            </p>
        </div>
        <footer>
